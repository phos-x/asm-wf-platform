...
def load_experiments(root: str) -> Dict[str, Any]:
    path = os.path.join(root, "core","registry", "experiments.yaml")
    return _load_yaml(path)


def load_datasets(root: str) -> Dict[str, Any]:
    path = os.path.join(root, "core", "registry", "datasets.yaml")
    return _load_yaml(path)


def load_tuning(root: str) -> Dict[str, Any]:
    path = os.path.join(root, "core","registry", "tuning.yaml")
    return _load_yaml(path)
...
def load_models_config(root: str) -> Dict[str, Any]:
    ...
    """
    path = os.path.join(root, "core", "config", "models.yaml")
    return _load_yaml(path)
